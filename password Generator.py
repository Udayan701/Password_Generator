...
Screen.title("password Generator by Udayan")
#program title
Title = StringVar()
TitleLabel = Label(Screen, textvariable=Title).pack()
Title.set("Choose Strength of Password-")
...
#length of password
Value = IntVar()
SpinLength = Spinbox(Screen, from_=6, to_=25 ,textvariable=Value,width=14).pack()
...
PassGenButton = Button(Screen,text="generate Password",bd=5, height=2 ,command=CallBack)
PassGenButton.pack()
